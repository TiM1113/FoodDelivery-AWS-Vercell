...
import validateRequest, { cartItemSchema } from "../middleware/validateRequest.js";
...
cartRouter.post("/add", authMiddleware, validateRequest(cartItemSchema), addToCart) // 1- addToCart function end point + add middleware on this cart router
cartRouter.post("/remove", authMiddleware, validateRequest(cartItemSchema), removeFromCart) // 2- removeFromCart function end point + add middleware on this cart router
